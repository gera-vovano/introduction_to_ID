...
int main()
{
	...
	CrossRoads^ elCR; // Объект класса "Перекресток" для использования текущего элемента массива объектов
	ATM^ elATM; // Объект класса "Банкомат" для использования текущего элемента массива объектов
